...
Der Befehl sollte eine Version von 2.4.0.0 oder höher ausgeben. Darunter erscheint der Pfad zur Konfigurationsdatei. 

Ansible hat keinen Hintergrundprozess und braucht daher nicht neu gestartet zu werden.

Wir wechseln in den Ordner /etc/ansible und sichern dort die hosts-Datei:
