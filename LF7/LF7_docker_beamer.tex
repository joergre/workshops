...
\frame{\frametitle{Sonstige Hilfen im Netz}
    \begin{itemize}
        \item Docker Mailing-Liste (\url{https://groups.google.com/forum/#!forum/docker-user})
        \item Docker auf IRC (irc.freenode.net Kanal: docker)
        \item Docker auf Twitter (\url{https://twitter.com/docker})
