...
\frame{\frametitle{Websites}
    \begin{itemize}
        \item Docker Homepage (\href{{https://www.docker.com})
        \item Docker Hub (\href{{https://hub.docker.com}) 
        \item Docker Blog (\href{{https://blog.docker.com})
        \item Docker Dukumentation (\href{{https://docs.docker.com})
        \item Docker "Getting Started Guide" (\href{{https://docs.docker.com/mac/})
        \item Docker Code - Github (\href{{https://github.com/docker/docker})
        \item Docker Forge -  Sammlung von Tools (\href{{https://github.com/dockerforge})
    \end{itemize}    
}
