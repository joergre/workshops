...
** Aufagbe
Vergleich die möglichen Befehle auf die Objekte tupel und list. Was fällt Dir auf? Vergleiche bitte mit dem befehl dir(list) bzw. dir(tupel).

* Dictonary

Dictonary odrnen Begriff paarweise einander zu:
