...
2.) Erkläre woran die Problematik der Funktion zu erkennen ist. Warum ist die Ackermann-Funktion so schwer zu berechnen?
...
Zip Datei test.zip wurde mit dem Passwort ASCII erstellt (für Testzwecke).
